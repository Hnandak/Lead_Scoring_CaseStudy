...
- Lead Score Case Study.ipynb : The python file exhibits Data analysis and its corresponding coding.
- Assignment Subjective Questions.pdf : Subjective Questions Answered with statistical facts from Jupyter notebook.
- Lead_Scoring Assignment.pdf : Final Presentation.
- Summary.pdf : Summary of complete analysis provided in py file.
